...
type Store interface {
	Querier
	CreateSessionLogTransaction(ctx context.Context, args CreateSessionLogParams) (CreateSessionLogTransactionResult, error)
...
type SQLStore struct {
	*Queries         // has all the methods generated by Sqlc
	db       *sql.DB // either database connection or a transaction.
}
...
func (store *SQLStore) CreateSessionLogTransaction(ctx context.Context, args CreateSessionLogParams) (CreateSessionLogTransactionResult, error) {
...
func (store *SQLStore) CreateUserTransaction(ctx context.Context, args CreateUserTransactiontArgs) (CreateUserResult, error) {
...
// CreateUserTransaction handles the creation of a user transaction based on the platform.
func (store *SQLStore) UpdateSessionFinishTransaction(ctx context.Context, args UpdateSessionFinishTransactionParams) error {
...
func (store *SQLStore) CreateUserForTestingDeletion(ctx context.Context) (CreateUserForTestingDeletionResult, error) {
